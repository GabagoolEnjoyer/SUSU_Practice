    ...
    match flag:
        ...
        case 2:
            ...
            if new_word in excel_data:
                ...
                excel_data[new_word] = [new_definition, new_example] #создание нового слова
        case 3:
        ...
        case 4:
            ...
            if redact_word in excel_data:
                ...
                print("Ошибка! Данного слова нет в словаре!")
        case 5:
            clear_excel(filename) #очистка старых записей
            save_dicts_to_excel(filename, excel_data) #добавление обновленных записей
            sys.exit()